...
/**
 * BasicTheme Class has its own images for ground/wall entities
 * and colors/fonts/style to decorate the dungeon interface under the concept of basic dungeon
 */
public class BasicTheme implements ThemeFactory {
	private String missionColor = "#c8eceb";
	private String completeColor = "#4b7eec";
	private String itemListColor = "#F2D6AB";
	...
	public Image getGroundImage() {
		return new Image("/dirt_0_new.png");
	}
	/**
