...
/**
 * OceanTheme Class has its own images for ground/wall entities
 * and colors/fonts/style to decorate the dungeon interface under the concept of Ocean.
 */
public class OceanTheme implements ThemeFactory {
	private String missionColor = "#9A390E";
	private String completeColor = "#267603";
	private String itemListColor = "#2B278E";
	...
	public Image getGroundImage() {
		return new Image("/waterset/water.png");
	}
	/**
	...
	public Image getWallImage() {
		return new Image("/waterset/slime0.png");
	}
	/**
